...
\begin{document}
\input{header}
\noindent\textbf{Assignment 3, Due Friday Jan 29}
\vskip.15in

{\bf Although this assignment is ostensibly due on Friday, it is LONG!
  Therefore, you may choose to submit the first three problems on
  Friday, and the rest of the homework before class starts on Wednesday.}
