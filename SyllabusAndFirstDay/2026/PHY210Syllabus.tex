% TODO(F2026): This is the Earlham 2024 syllabus (Physics 360, Boas), copied
% here as a starting point for Smith PHY 210, Fall 2026. NOT YET UPDATED.
% Before using, at minimum:
%   - Course number/title: Physics 360 -> PHY 210, Smith College
%   - Textbook: Boas 3e -> Felder & Felder, Mathematical Methods in
%     Engineering and Physics (all section references change!)
%   - Calendar: replace with the F2026 schedule ("PHY210 F2026 Calendar.xlsx"
%     in this directory; regenerate via make_fall2026_calendar.py)
%   - Dates: classes Wed Sep 9 - Mon Dec 14 (MWF); finals Dec 19-22
%   - Grading: previous Smith prof used weekly written HW (WHW01-13),
%     3 in-class Friday quizzes, final; decide what to keep from the
%     Earlham scheme (projects? Non-Newtonian Physicist? late passes?)
%   - Earlham-specific policies/offices -> Smith equivalents (accommodations,
%     tutoring, Title IX, honor code); Piazza -> Moodle
...
\begin{center}
{\bf Physics 360: Mathematical Methods of Physics
}
\end{center}
...
\begin{description}
  \item[Office Hours:] TBD. I also have an open-door policy, and you're
  ...
  \item[When and where:] Class meetings will be
        MWF 11:00-12:50 in CST 225.  If Zoom sessions are needed, they will
