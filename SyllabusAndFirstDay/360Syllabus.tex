...
\begin{center}
{\bf Physics 360/Math 360  \ \ MWF 10:00 - 10:50 PM,  Room:  CST 314
}
\end{center}
...
\vskip.15in
\noindent\textbf{Office Hours:} Afternoons, TBD,
...
\begin{itemize}
  \item Class preparation/participation, Piazza participation: 10\%
...
\begin{flushleft}
Drop Deadline \dotfill 4/1/2016\\
Mini-Midterm, Power Series and Complex Numbers \dotfill 1/27/2016\\
Midterm 1 \dotfill 3/2/2016\\
Independent Project Topics \dotfill 3/23/2016\\
Paragraph about Project \dotfill 3/25/2016\\
Independent Project Draft 1 \dotfill 4/6/2016\\
Midterm 2 \dotfill 4/11/2016\\
Independent Project Draft 2 \dotfill 4/20/2016\\
Final Exam, Comprehensive emphasis on later topics \dotfill 5/2/2016\\
\end{flushleft}
\end{minipage}
\end{center}
...
Bessel Functions \\
Noether's Theorem {\em or, likely, student's choice.}
\end{flushleft}
\end{minipage}
\end{center}
\vskip.1in
...
\vskip.15in
\noindent\textbf{Independent project}: The primary goals of this
course are involve developing a level of mathematical sophistication
that will allow you to confidently and competently explore further
material outside of a lecture setting. So, in order to make sure we're
walking the walk, you'll each pick either an interesting problem to
...
at that point. Examples might include 
...
\caltextnext{Noether's Theorem or class choice! 5 days.}
\caltextnext{}
\caltextnext{}
\caltextnext{}
\caltextnext{}
...
% Holidays
\Holiday{1/11/2016}{Winter break}
\Holiday{1/12/2016}{Winter break}
\Holiday{2/18/2016}{\textit{Early Semester Break\\yay!}}
\Holiday{2/19/2016}{\textit{Early Semester Break\\yay!}}
\Holiday{2/20/2016}{\textit{Early Semester Break\\yay!}}
\Holiday{2/21/2016}{\textit{Early Semester Break\\yay!}}

\Holiday{3/12/2016}{\textit {Spring Break}}
\Holiday{3/13/2016}{\textit {Spring Break}}
\Holiday{3/14/2016}{\textit {Spring Break}}
\Holiday{3/15/2016}{\textit {Spring Break}}
\Holiday{3/16/2016}{\textit {Spring Break}}
\Holiday{3/17/2016}{\textit {Spring Break}}
\Holiday{3/18/2016}{\textit {Spring Break}}
\Holiday{3/19/2016}{\textit {Spring Break}}
\Holiday{3/20/2016}{\textit {Spring Break}}

\Holiday{4/30/2016}{Reading Day} 
\Holiday{5/1/2016}{Reading Day} 
\Holiday{5/2/2016}{Finals: comprehensive but with emphasis on
  later topics} 
\Holiday{5/3/2016}{Reading Day} 
\Holiday{5/4/2016}{Finals} 
\Holiday{5/5/2016}{Finals} 
% ... and so on

\caltext{4/1/2016}{\framebox{Last day to drop}}
\caltext{4/29/2016}{\framebox{Last class}}
